        ...
        <div className='service-container'>
            ...
            <div className='first-section1'>
                <div className='admission'>
                         <div className='admission1'>
                                    <h1>Admissions to university</h1>
                ...
                <div className='document-format'>
                        <div className='document-format1'>
            ...
            <div className="second-section1">
                <div className="hundred-percent">
                    <p className="hundred-percent1">100%</p>
                </div>     
                <div className="client">
                    <p className="client1">Client's</p>
                </div>     
                <div className="satisfaction">
                    <p className="satisfaction1">Satisfaction</p>
                </div>     
            </div>
